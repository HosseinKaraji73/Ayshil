                    ...
                    <div id="main">
                        ...
                        <section id="content" class="page-content card card-block centerhossein1">
                            ...
                            <section class="register-form">
                                <p>{{__('auth.registerAlready')}} <a href="{{ route('login') }}">{{__('auth.loginSubmit')}}</a></p>

                                <form method="POST" action="{{ route('register') }}" id="customer-form" class="js-customer-form">
                                    @csrf
                                    <section>

                                        <div class="form-group row ">
                                            <label for="mobile" class="col-md-2 form-control-label required">
                                                {{__('auth.registerPhone')}}
                                            </label>
                                            <div class="col-md-8">
                                                <input id="mobile" name="mobile" class="form-control @error('mobile') is-invalid @enderror" type="text"  value="{{ old('mobile') }}" placeholder="09123456789">
                                                @error('mobile')
                                        ...
                                        <div class="form-group row ">
                                            <label for="mobile" class="col-md-2 form-control-label required">
                                                {{__('auth.registerClub')}}
                                            </label>
                                            <div class="col-md-8">
                                                <input id="parentReagent" name="parentReagent" class="form-control @error('parentReagent') is-invalid @enderror" type="text"  placeholder="اختیاری">
                                                @error('parentReagent')
                                                <span class="invalid-feedback redfeedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
...
{{--                                        <div class="form-group row ">--}}
{{--                                            <label for="password" class="col-md-2 form-control-label required">--}}
{{--                                                {{__('auth.registerPass')}}--}}
{{--                                            </label>--}}
{{--                                            <div class="col-md-8">--}}
{{--                                                <div class="input-group js-parent-focus">--}}
{{--                                                    <input id="password" name="password" class="form-control js-child-focus js-visible-password @error('password') is-invalid @enderror" type="password" value="{{ old('password') }}">--}}
{{--                                                    @error('password')--}}
{{--                                                    <span class="invalid-feedback redfeedback" role="alert">--}}
{{--                                                    <strong>{{ $message }}</strong>--}}
{{--                                                </span>--}}
...
{{--                                                      <button class="btn" type="button" data-action="show-password" data-text-show="{{__('auth.registerViewPass')}}" data-text-hide="{{__('auth.registerHidePass')}}">--}}
{{--                                                          {{__('auth.registerViewPass')}}--}}
{{--                                                      </button>--}}
{{--                                                    </span>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
