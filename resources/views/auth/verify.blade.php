                        ...
                        <section id="content" class="page-content card card-block">
                                ...
                                <form id="login-form" action="{{ route('login') }}" method="post">
                                    ...
                                    <section>
                                        ...
                                        <div class="form-group row ">
                                            <label class="col-md-2 form-control-label required">{{__('auth.loginPhone')}}</label>
                                            <div class="col-md-8">
                                                <input class="form-control @error('email') is-invalid @enderror" name="email" type="email" value="" required>
                                                @error('email')
                                        ...
                                        <div class="form-group row ">
                                            <label class="col-md-2 form-control-label required">{{__('auth.loginPassword')}}</label>
                                            <div class="col-md-8">
                                                <div class="input-group js-parent-focus">
                                                    <input class="form-control js-child-focus js-visible-password @error('password') is-invalid @enderror" name="password" type="password" value="" pattern=".{5,}" required>
                                                    @error('password')
                                                    <span class="invalid-feedback" role="alert">
                                                           <strong>{{ $message }}</strong>
                                                          </span>
                            ...
                            <div class="no-account">
                                @if (Route::has('password.request'))
                                    <a href="{{ route('password.request') }}" data-link-action="display-register-form">
