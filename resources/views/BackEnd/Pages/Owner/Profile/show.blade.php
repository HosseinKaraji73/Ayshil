    ...
    <div class="col-sm-8 col-sm-push-2">
        ...
        <div class="box box-primary">
            <div class="box-body box-profile">
                <img class="profile-user-img img-responsive img-circle" src="{{$user->avatar}}" alt="User profile picture" style="width: 90px;margin: 0 auto;">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <a href="{{route('chef.edit',$user->id)}}" class="form-control btn btn-primary"><span class="fa fa-edit">&nbsp;</span><b>ویرایش اطلاعات</b></a>
                    </div>
                    <div class="col-sm-6">
                        <a href="{{action('BackEnd\Chef\UserController@changePasswordForm')}}" class="form-control btn btn-success"><span class="fa fa-key">&nbsp;</span><b>تغییر رمزعبور </b></a>
                    </div>
                </div>
