...
@section('head-content')
    <span class="fa fa-eye">&nbsp;</span>  مشاهده جزییات خبر
@endsection
                    ...
                    <div style="overflow-x: auto;">
                        <table class="table table-striped table-bordered table-hover centerTable tdAlign"
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($event->photo1)
                                        <img src="{{asset("img/Admin/event/$event->photo1")}}" style="width: 100px">
                                        @else
                                        <img src="{{asset('img/admin/null.png')}}" style="width: 100px">
                                    @endif
{{--                                    @if($event->photo2)--}}
{{--                                        <img src="{{asset("img/Admin/event/$event->photo2")}}" style="width: 100px">--}}
{{--                                        @else--}}
{{--                                            <img src="{{asset('img/admin/null.png')}}" style="width: 100px">--}}
{{--                                    @endif--}}
{{--                                    @if($event->photo3)--}}
{{--                                        <img src="{{asset("img/Admin/event/$event->photo3")}}" style="width: 100px">--}}
{{--                                        @else--}}
{{--                                            <img src="{{asset('img/admin/null.png')}}" style="width: 100px">--}}
{{--                                    @endif--}}
{{--                                    @if($event->photo4)--}}
{{--                                        <img src="{{asset("img/Admin/event/$event->photo4")}}" style="width: 100px">--}}
{{--                                        @else--}}
{{--                                            <img src="{{asset('img/admin/null.png')}}" style="width: 100px">--}}
{{--                                    @endif--}}
                            ...
                            <tr>
                                <th class="text-center">نام خبر</th>
                                <td>
                                    {{$event->title}}
                                    {{$event->title_en}}
                                </td>
