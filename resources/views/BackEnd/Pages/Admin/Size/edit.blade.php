...
@section('head-content')
    <span class="fa fa-pencil">&nbsp;</span>ویرایش سایز
@endsection
@section('content')
    ...
    <div class="col-sm-8 col-sm-push-2">
        ...
        {!! Form::model($size,['method'=>'PATCH','action'=>['BackEnd\Admin\SizeController@update',$size->id],'files'=>true ,'id' =>'myForm'])!!}
...
{{--        </div>--}}
        ...
        <div class="row">
            ...
            {!! Form::open(['method'=>'DELETE', 'action'=>['BackEnd\Admin\SizeController@destroy', $size->id]]) !!}
            <div class="form-group col-sm-6">
