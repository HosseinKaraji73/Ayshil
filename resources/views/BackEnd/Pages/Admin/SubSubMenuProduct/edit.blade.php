...
@section('head-content')
    <span class="fa fa-pencil">&nbsp;</span>ویرایش زیر منو
@endsection
@section('content')
    ...
    <div class="col-sm-8 col-sm-push-2">
        ...
        {!! Form::model($SubMenuProduct,['method'=>'PATCH','action'=>['BackEnd\Admin\SubSubMenuProductController@update',$SubMenuProduct->id],'files'=>true ,'id' =>'myForm'])!!}
...
{{--        </div>--}}
        ...
        <div class="row">
            ...
            {!! Form::open(['method'=>'DELETE', 'action'=>['BackEnd\Admin\SubMenuProductController@destroy', $SubMenuProduct->id]]) !!}
            <div class="form-group col-sm-6">
