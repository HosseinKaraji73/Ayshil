...
@section('content')
    ...
    <div class="col-sm-8 col-sm-push-2">
        ...
        {!! Form::model($color,['method'=>'PATCH','action'=>['BackEnd\Admin\ColorController@update',$color->id],'files'=>true ,'id' =>'myForm'])!!}
...
{{--        </div>--}}
        ...
        <div class="row">
            ...
            {!! Form::open(['method'=>'DELETE', 'action'=>['BackEnd\Admin\ColorController@destroy', $color->id]]) !!}
            <div class="form-group col-sm-6">
