...
{{--                        </a>--}}
        ...
        <div class="container">
            <div class="row">
                <div class="valign-middle">
                    <div class="hidden-md-down innovatoryLogo col-md-3 col-lg-3 hidden" id="_desktop_logo">
{{--                        <a href="{{url('/')}}">--}}
{{--                            <img class="logo img-responsive" src="{{asset('FrontEnd/images/settings/header-logo.png')}}" width="auto" height="auto" alt="Demo Store">--}}
{{--                        </a>--}}
                    </div>
                    <div class="hidden-md-down search-wrap col-lg-6" id="myHeader">
                        <div id="_desktop_search" class="innovatoryDisplaySearch hidden-md-down">
...
{{--                                ‍   <span class="expand-more hidden-lg-up" data-toggle="dropdown">--}}
                                ...
                                <div class="innovatorySearch dropdown-menu">
                                    ...
                                    <div id="search_block_top" class="search_block_top">
                                        ...
                                        <form id="searchbox" method="get" action="#">
                                            ...
                                            {{--                                                                                                class="form-control">--}}
                                            {{--                                                                                            <option value="all"> همه منو ها</option>--}}
                                            {{--                                                                                            <option value="2">Home</option>--}}
                                            {{--                                                                                        </select>--}}
                                            <input class="search_query form-control" type="text" id="search_query_top" name="s" placeholder="{{__('settings.search')}}" value=""/>
    ...
    <script>
        ...
        $(window).scroll(function(){
            if ($(window).scrollTop() >= 70) {
                $('.search-wrapMob').addClass('sticky2');
                // $('nav div').addClass('visible-title');
            }
            else {
                $('.search-wrapMob').removeClass('sticky2');
                // $('nav div').removeClass('visible-title');
            }
        });
    </script>
