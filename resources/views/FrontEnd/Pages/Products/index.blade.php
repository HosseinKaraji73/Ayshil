...
{{--                                    <input class="checkbox-ajax" autocomplete="off" name="categoryValueCheckbox[]"--}}
...
{{--                                               rel="nofollow"> {{__('settings.special')}}--}}
...
{{--                                    </span>--}}
{{--                                            <a href="" class="_gray-darker search-link js-search-link"--}}
{{--                                               rel="nofollow"> {{__('settings.bestSell')}}--}}
{{--                                                --}}{{--                                                                                                <span class="magnitude">(2)</span>--}}
{{--                                            </a> </label>--}}
{{--                                    </li>--}}
...
{{--                                    </span>--}}
{{--                                    </span>--}}
{{--                                            <a href="{{url('/activate-carbon')}}"--}}
{{--                                               class="_gray-darker"> {{__('settings.menu3')}}--}}
{{--                                                --}}{{--                                                                                                <span class="magnitude">(2)</span>--}}
{{--                                            </a> </label>--}}
{{--                                    </li>--}}
                                                                    ...
                                                                    <div class="innovatory-product-description">
                                                                        <div class="comments_note">
                                                                            <div class="star_content">
                                                                                <div class="Rate">
                                                                                    <span
                                                                                        class="stars"> {{round($productTopSelling2->chefRate ,2)}}</span>
                                                                                </div>
                                                                            </div>
                                                                            <span
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            @if(isset($productTopSelling2->discount))
                                                                                <span itemprop="price"
                                                                                      class="price">{{$productTopSelling2->price_after_discount}} {{__('settings.tuman')}}</span>
                                                                    ...
                                                                    <div class="innovatory-product-description">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            @if(isset($productSpecial2->discount))
                                                                                <span itemprop="price"
                                                                                      class="price">{{$productSpecial2->price_after_discount}} {{__('settings.tuman')}}</span>
                                                                    ...
                                                                    <div class="innovatory-product-description">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            @if(isset($productNew2->discount))
                                                                                <span itemprop="price"
                                                                                      class="price">{{$productNew2->price_after_discount}} {{__('settings.tuman')}}</span>
...
{{--                                        <div id="search_filters">--}}
                                            ...
                                            <section class="facet clearfix topSearch2">

                                                <ul id="topSearch" class="collapse">
                                                    <p>بر اساس:</p>
                                                    <li>
                                                        <label class="facet-label">
                                                            <a href="" class="_gray-darker search-link js-search-link" rel="nofollow"> {{__('settings.special')}}</a>
                                                    ...
                                                    <li>
                                                        <label class="facet-label">
                                                            <a href="" class="_gray-darker search-link js-search-link" rel="nofollow"> {{__('settings.bestSell')}}</a>
...
{{--                                                    </li>--}}
                                                    ...
                                                    <li>
                                                        <label class="facet-label">
                                                            <a href="" class="_gray-darker search-link js-search-link" rel="nofollow"> {{__('settings.new')}}</a>
...
{{--                                               aria-haspopup="true" aria-expanded="false"> بر اساس حروف--}}
{{--                                                <i class="material-icons pull-xs-right">&#8690;</i> </a>--}}
{{--                                            <div class="dropdown-menu">--}}
{{--                                                <a rel="nofollow" href="4-kitchen-tools-order=product.position.asc.html"--}}
...
{{--                                        </div>--}}
{{--                                        <span--}}
{{--                                            class=" hidden-sm-down sort-by pull-right">{{__('settings.sortBy')}}</span>--}}
                                                    ...
                                                    <article class="product-miniature js-product-miniature"
                                                        ...
                                                        <div class="innovatoryProduct-container item">
                                                            <div class="innovatoryProduct-image">
                                                                <a href="{{action('FrontEnd\ProductController@show' ,[$product->id,$product->title,$product->title_en])}}"
                                                                   class="thumbnail product-thumbnail">
                                                                  <span class="cover_image">
                                                                        <img
                                                                            src="{{asset("img/admin/product/$product->photo1")}}"
                                                                ...
                                                                @if(isset($product->discount))
                                                                    <span
                                                                        class="reduction_percent_display innovatorySale-label">%{{$product->discount}}</span>
                                                                @endif
                                                            ...
                                                            <div class="innovatory-product-description">
                                                                <div class="comments_note">
                                                                    <div class="star_content">
                                                                        <div class="Rate">
                                                                            <span
                                                                                class="stars"> {{round($product->rate ,2)}}</span>
                                                                        </div>
                                                                    </div>
                                                                    <span
                                                                        class="laberCountReview pull-left">Review</span>
                                                                ...
                                                                <div class="innovatory-product-price-and-shipping">
                                                                    @if(isset($product->discount))
                                                                        <span
                                                                            class="old-price regular-price">{{$product->price}}</span>
                                                                        <span itemprop="price"
                                                                              class="price">{{$product->price_after_discount}}</span>
                                                                    @else
                                                                        <span
