...
@if(App::getLocale() == 'fa')
    @section('title','فروشگاه انرژی پاک')
@elseif(App::getLocale() == 'en')
    @section('title','Activate Carbon Product')
@endif
                    ...
                    <ol itemscope itemtype="#">
                        ...
                        <li itemprop="itemListElement" itemscope itemtype="{{url('products')}}">
                            <a itemprop="item" href="{{url('products')}}">
                                <span itemprop="name">{{__('settings.cleanRoute')}}</span> </a>
            ...
            <section id="main">
                <div class="block-category card card-block">
                    ...
                    <div class="category-cover">
                        <img src="{{asset("img/admin/setting/$menuPic->photo5")}}" alt="">
                    </div>
                                                            ...
                                                            <div class="row no-margin">
                                                                <div class="pull-left product_img">
                                                                    <a href="" class="thumbnail product-thumbnail"><img
                                                                            ...
                                                                            alt=""
                                                                            data-full-size-image-url="https://innovatorythemes.com/prestashop/INNO02/INNO1001_Cucina/IT01/202-large_default/slotted-spoon-stainless-silver.jpg"
                                                                            width="auto"
                                                                            height="auto"></a>
                                                                </div>
                                                                    ...
                                                                    <div class="innovatory-product-description">
                                                                        <div class="comments_note">
                                                                            <div class="star_content">
                                                                                <div class="Rate">
                                                                                    <span class="stars"> {{round($productTopSelling2->rate ,2)}}</span>
                                                                                </div>
                                                                            </div>
                                                                            <span
                                                                        ...
                                                                        <h2 class="h2 productName" itemprop="name"><a
                                                                                href="home/47-304-slotted-spoon-stainless-silver.html#/8-color-white">{{$productTopSelling2->title}}</a>
                                                                        </h2>
                                                    ...
                                                    <article class="product-miniature js-product-miniature" data-id-product="{{$product->id}}" data-id-product-attribute="{{$product->id}}" itemscope itemtype="">
                                                        <div class="innovatoryProduct-container item">
                                                            <div class="innovatoryProduct-image">
                                                                <a href="{{action('FrontEnd\ActiveCarbonController@show' ,[$product->id,$product->title,$product->title_en])}}" class="thumbnail product-thumbnail">
