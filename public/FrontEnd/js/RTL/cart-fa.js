...
function displayCart() {
    ...
    for (var i in cartArray) {
        output +=
            ...
            +
            "<td class='tdPrice persian-digit'>(" + cartArray[i].price + ")تومان</td>"
            +
            ...
            +
            "<input type='text' class='item-count form-control persian-digit' data-id='" + cartArray[i].id + "' value='" + cartArray[i].count + "'>"
            +
            ...
            + " = " + "<td class='tdTotal persian-digit'>"
            + cartArray[i].total + "تومان </td>"
            +
            "</tr>";
