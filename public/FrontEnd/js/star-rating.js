(function (factory) {
    ...
    var $h, Rating;
    $h = {
        NAMESPACE: '.rating', DEFAULT_MIN: 0, DEFAULT_MAX: 5, DEFAULT_STEP: 0.5, isEmpty: function (value, trim) {
    ...
    Rating.prototype = {
        constructor: Rating, _parseAttr: function (vattr, options) {
            ...
            self.disabled = opts.disabled === undefined ? $el.attr('disabled') || !1 : opts.disabled;
            self.readonly = opts.readonly === undefined ? $el.attr('readonly') || !1 : opts.readonly;
            ...
            if ($form.length) {
                $h.handler($form, 'reset', $.proxy(events.resetForm, self), !0)
            }
            return $el
            ...
            var self = this, defaultVal = $h.isEmpty(self.$element.val()) ? 0 : self.$element.val(),
                val = arguments.length ? self.getValueFromPosition(pos) : defaultVal, caption = self.fetchCaption(val),
            ...
            return self.destroy().rating($.extend(!0, self.options, options)).trigger('rating.refresh')
        }
    };
    $.fn.rating = function (option) {
        ...
        this.each(function () {
            ...
            if (!data) {
                ...
                opts = $.extend(!0, {}, $.fn.rating.defaults, thm, $.fn.ratingLocales.en, loc, options, self.data());
